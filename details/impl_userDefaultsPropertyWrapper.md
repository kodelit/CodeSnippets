# Impl: UserDefaultsPropertyWrapper
- **shortcut**: `impl_userDefaultsPropertyWrapper`
- **language**: Swift
- **platform**: 
...
//  Copyright © 2019 Grzegorz Maciak. All rights reserved.
...
extension Optional: PlistCompatible { }
...
public extension UserDefaultStorageManipulating {
    func removeStorageValue() {
